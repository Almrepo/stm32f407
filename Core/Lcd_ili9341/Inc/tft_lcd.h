...
#define TFT_RST_SET       HAL_GPIO_WritePin(GPIOD, GPIO_PIN_6, GPIO_PIN_SET);         // 1 �� ����� reset �������
#define TFT_RST_RESET     HAL_GPIO_WritePin(GPIOD, GPIO_PIN_6, GPIO_PIN_RESET);       // 0 �� ����� reset
